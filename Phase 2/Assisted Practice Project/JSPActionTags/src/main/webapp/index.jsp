...
<jsp:useBean id="productBean" class="com.ecommerce.ProductBean" scope="session"></jsp:useBean>
		...
		<a href="showbean.jsp">Access bean properties from another page</a><br><br>
		<a href="forward.jsp">Use Forward action to go to Google</a><br>

<hr>

<jsp:text>
        <![CDATA[<br>This is my content.<br/><br>This will show within a text action tag exactly as it has been entered]]>
</jsp:text>
